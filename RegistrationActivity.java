...
public class RegistrationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        continueAndNextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                if (continueAndNextBtn.getText().equals("Submit") || checker.equals("Code Sent"))
                {
                    ...
                    {
                        Toast.makeText(RegistrationActivity.this,"Please provide your code ",Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    {
                        Toast.makeText(RegistrationActivity.this,"Please enter a valid phone Number",Toast.LENGTH_SHORT);
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            {
                Toast.makeText(RegistrationActivity.this, "Invalid phone Number Entered", Toast.LENGTH_SHORT).show();
